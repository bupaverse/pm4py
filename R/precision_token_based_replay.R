#' Measure Token-Based Replay Precision
#'
...
precision_token_based_replay <- function(log,
                                       marked_petrinet,
                                       convert = TRUE) {
  UseMethod("precision_token_based_replay")
}

#' @export
precision_token_based_replay.log <- function(log,
                                                marked_petrinet,
                                                convert = TRUE) {
  ...
  pm4py_conformance$precision_token_based_replay(log = py_log, petri_net = py_pn,
                                               initial_marking = im,
                                               final_marking = fm,
